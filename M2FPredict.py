...
if __name__ == "__main__":
    ...
    # ---------------- 输入/模型 ----------------
    parser.add_argument("--input", type=str, default=r"BijieOnlyLandslide/VOC2012/JPEGImages",
                        help="输入：单张图片 / 包含 RGB 的文件夹")
    parser.add_argument("--dem_dir", type=str, default=r"BijieOnlyLandslide/VOC2012/DEMImages",
                        help="DEM 文件夹的路径（用于双流推理）")

    parser.add_argument("--ckpt", type=str,
                        default=r"run/train/exp12/weights/best_m2f_deeplabv3plus_xception16_os8_num2.pth",
                        help="模型权重路径")
