...
class SegMetricHistory:
    ...
    val_ls_mcc: List[float] = field(default_factory=list)  # 【新增】滑坡 MCC
...
class SegMetricsLogger:
    ...
    def __init__(self, exp_dir: str, csv_name: str = "metrics.csv"):
        ...
        self.fieldnames = [
            ...
            "val_bg_iou", "val_bg_prec", "val_bg_rec", "val_bg_f1", "val_bg_mcc", # 【新增】 val_bg_mcc
            "val_ls_iou", "val_ls_prec", "val_ls_rec", "val_ls_f1", "val_ls_mcc"  # 【新增】 val_ls_mcc
        ]
    ...
    def log_epoch(self, epoch: int, lr: float, train_loss: float, train_pacc: float, val_loss: float, val_score: Dict) -> None:
        ...
        cls_mcc = val_score.get("Class MCC", {0: 0.0, 1: 0.0}) # 【新增】获取 MCC
        ...
        self.history.val_ls_mcc.append(row["val_ls_mcc"]) # 【新增】保存滑坡 MCC 历史
    ...
    def save_plots(self) -> None:
        ...
        plt.plot(epochs, self.history.val_ls_mcc, label="Landslide MCC", color='purple', linestyle='-.') # 【新增】绘制 MCC
        plt.xlabel("epoch")
        plt.ylabel("score")
